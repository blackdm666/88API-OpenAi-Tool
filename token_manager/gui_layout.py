...
class GUILayoutMixin:
    ...
    def _build_sub2api_tab(self, parent) -> None:
        ...
        menu.add_separator()
        menu.add_command(label='启用选中',command=lambda:self.set_selected_sub2api_status('active'))
        menu.add_command(label='停用选中',command=lambda:self.set_selected_sub2api_status('inactive'))
        menu.add_separator()
